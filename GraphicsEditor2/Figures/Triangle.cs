...
{
    [Serializable]
    public class Triangle : Figure, IVertexSupport, IRotateSupport, ISolidFigure
    {
        public Triangle(Point origin, Point offset)
        {
            ...
            var points = new List<PointF>
                {
                    ...
                    new PointF(rect.Right, rect.Top + rect.Height)
                };
